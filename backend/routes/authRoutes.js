...
// Obtener todos los usuarios con sus partidos (solo admin)
router.get("/users", verifyToken, verificarRol(['administrador']), authController.getUsersWithMatches);

// Eliminar usuario (solo admin)
router.delete("/users/:id", verifyToken, verificarRol(['administrador']), authController.deleteUser);
